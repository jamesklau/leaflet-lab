//initializes the map and set its view to our chosen geographical coordinates and a zoom level
var mymap = L.map('mapid').setView([51.505, -0.09], 13);

//atributes with id and accesstoken
...
//adds a polygon and its attributes
...
//calls popups and inputs what they say when clicked
...
//creates and adds the map
L.geoJSON(geojsonFeature).addTo(map);

//Pass a simple object that styles all paths (polylines and polygons) the same way:
var myLines = [{
    "type": "LineString",
